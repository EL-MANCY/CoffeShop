    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // when this button is clicked we want to save our values in the database and send those values
...
//if its empty (mCurrentCartUri) it will insert the data in the table
